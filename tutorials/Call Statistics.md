...
Collecting Call statistics is done by invoking the [`call.getStats`](https://ribboncommunications.github.io/webrtc-anonymous-js-sdk/docs/#callgetstats) API.
...
client.on('call:start', function (params) {
   ...
   timer = setInterval(retrieveCallStats, TIMER_INTERVAL) // trigger stats collection every 1 second
}
```
